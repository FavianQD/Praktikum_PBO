from PySide6.QtWidgets import QApplication, QMainWindow, QPushButton, QLabel, QVBoxLayout, QWidget, QLineEdit, QMessageBox, QTextEdit  # type: ignore
...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.result_text.setFont(QFont('Arial'))
    ...
    def show_data(self):
        try:
            ...
            result_text = "Data Users:\n================================"
            for row in records:
                result_text += f"Nama: {row[0]}\n NIM: {row[1]}\n Hobi: {row[2]}\n================================"
